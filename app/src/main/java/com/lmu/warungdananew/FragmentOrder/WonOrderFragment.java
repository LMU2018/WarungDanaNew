 ...
 */
public class WonOrderFragment extends Fragment {
    ...
    public void onStart() {
        ...
        firstLoad();
/*
        mApiService.listOrder(idUser, 5, null).enqueue(new Callback<RespListOrder>() {
            @Override
...
*/
    ...
    private void firstLoad() {
        ...
        mApiService.listOrderPagg(idUser, 5, null, limit, 0).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()) {
    ...
    private void loadMore() {
        itShouldLoadMore = false;
        mApiService.listOrderPagg(idUser, 5, null, limit, offset).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()) {
                    itShouldLoadMore = true;

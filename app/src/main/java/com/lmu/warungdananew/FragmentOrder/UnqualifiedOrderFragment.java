 ...
 */
public class UnqualifiedOrderFragment extends Fragment {
    ...
    public UnqualifiedOrderFragment() {
    ...
    public void onStart() {
        ...
        firstLoad();
/*
        mApiService.listOrder(idUser, 4, null).enqueue(new Callback<RespListOrder>() {
            @Override
...
*/
    ...
    private void firstLoad() {
        ...
        mApiService.listOrderPagg(idUser, 4, null, limit, 0).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()) {
    ...
    private void loadMore() {
        itShouldLoadMore = false;
        mApiService.listOrderPagg(idUser, 4, null, limit, offset).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()) {
                    itShouldLoadMore = true;

package com.lmu.warungdananew.FragmentOrder;
...
import com.lmu.warungdananew.Adapter.ListOrderAdapter;
import com.lmu.warungdananew.Adapter.ListUserLogAdapter;
import com.lmu.warungdananew.R;
import com.lmu.warungdananew.Response.ListOrder;
import com.lmu.warungdananew.Response.ListUserLog;
 ...
 */
public class LostOrderFragment extends Fragment {
    ...
    public void onStart() {
        ...
        firstLoad();
/*
        mApiService.listOrder(idUser, 3, null).enqueue(new Callback<RespListOrder>() {
            @Override
...
*/
    ...
    private void firstLoad() {
        ...
        mApiService.listOrderPagg(idUser, 3, null, limit, 0).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()) {
    ...
    private void loadMore() {
        itShouldLoadMore = false;
        mApiService.listOrderPagg(idUser, 3, null, limit, offset).enqueue(new Callback<RespListOrder>() {
            @Override
            public void onResponse(Call<RespListOrder> call, Response<RespListOrder> response) {
                if (response.isSuccessful()) {
                    itShouldLoadMore = true;

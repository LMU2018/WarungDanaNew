...
public class ListLogAdapter extends RecyclerView.Adapter<ListLogAdapter.ListLeadHolder> {
    List<ListLog> listLeads;
    Integer idLead;
    Context context;

    public ListLogAdapter(Context context, List<ListLog> list) {
    ...
    public ListLeadHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ListLogAdapter.ListLeadHolder(view);
    }
    ...
    public void onBindViewHolder(ListLeadHolder holder, int position) {
        final ListLog listLead = listLeads.get(position);

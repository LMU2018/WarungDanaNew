...
import com.lmu.warungdananew.AddLeadLogActivity;
import com.lmu.warungdananew.R;
import com.lmu.warungdananew.Response.ListPhone;

import java.util.List;

public class ListPhoneAdapter extends RecyclerView.Adapter<ListPhoneAdapter.ListLeadHolder> {
    List<ListPhone> listLeads;
    Integer idLead;
    Context context;

    public ListPhoneAdapter(Context context, List<ListPhone> list) {
    ...
    public ListLeadHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ListPhoneAdapter.ListLeadHolder(view);
    }

...
public class RespListContactCollaborate {
    ...
    @SerializedName("data")
    @Expose
    private List<ListContactCollaborate> data = null;
    ...
    public List<ListContactCollaborate> getData() {
        return data;
    }

    public void setData(List<ListContactCollaborate> data) {
        this.data = data;
    }

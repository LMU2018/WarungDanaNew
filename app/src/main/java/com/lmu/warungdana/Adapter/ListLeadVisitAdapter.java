...
public class ListLeadVisitAdapter extends RecyclerView.Adapter<ListLeadVisitAdapter.ListLeadHolder> implements Filterable {
    ...
    public ListLeadVisitAdapter(Context context, ArrayList<ListLeadVisit> list) {
    ...
    public void onBindViewHolder(final ListLeadHolder holder, int position) {
        final ListLeadVisit listLead = listLeads.get(position);
        ...
        if (listLead.getLastName() == null) {
            ...
            holder.deskripsi.setText(listLead.getVisit_status());


            holder.tanggal.setText(convertTime(listLead.getCreated_at_lead_visum()));

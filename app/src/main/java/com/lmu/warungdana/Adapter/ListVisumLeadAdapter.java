...
public class ListVisumLeadAdapter extends RecyclerView.Adapter<ListVisumLeadAdapter.ListLeadHolder> {
    List<ListVisumLead> listLeads;
    Integer idLead;
    Context context;

    public ListVisumLeadAdapter(Context context, List<ListVisumLead> list) {
    ...
    public ListLeadHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ListVisumLeadAdapter.ListLeadHolder(view);
    }
    ...
    public void onBindViewHolder(ListLeadHolder holder, int position) {
        final ListVisumLead listLead = listLeads.get(position);
        ...
        if (listLead.getLeadLastName() == null) {
            konsumen = listLead.getLeadFirstName();
        } else {
            konsumen = listLead.getLeadFirstName() + " " + listLead.getLeadLastName();
        }

...
public class RespListCategoryAddress {
    ...
    @SerializedName("data")
    @Expose
    private List<ListCategoryAddress> data = null;
    ...
    public List<ListCategoryAddress> getData() {
        return data;
    }

    public void setData(List<ListCategoryAddress> data) {
        this.data = data;
    }

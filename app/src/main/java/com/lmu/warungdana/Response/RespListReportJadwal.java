...
public class RespListReportJadwal {
    ...
    @SerializedName("data")
    @Expose
    private List<ListReportJadwal> data = null;
    ...
    public List<ListReportJadwal> getData() {
        return data;
    }

    public void setData(List<ListReportJadwal> data) {
        this.data = data;
    }

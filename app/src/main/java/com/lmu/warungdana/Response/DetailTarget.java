...
public class DetailTarget {
    ...
    @SerializedName("id_target_visum")
    @Expose
    private Integer idTargetVisum;
    @SerializedName("visum_status")
    @Expose
    private String visumStatus;
    @SerializedName("logTotal")
    @Expose
    private Integer logTotal;
    @SerializedName("noteTotal")
    @Expose
    private Integer noteTotal;
    @SerializedName("visumTotal")
    @Expose
    private Integer visumTotal;
    ...
    public Integer getIdTargetVisum() {
        return idTargetVisum;
    }

    public void setIdTargetVisum(Integer idTargetVisum) {
        this.idTargetVisum = idTargetVisum;
    }

    public String getVisumStatus() {
        return visumStatus;
    }

    public void setVisumStatus(String visumStatus) {
    ...
    public Integer getVisumTotal() {
        return visumTotal;
    }

    public void setVisumTotal(Integer visumTotal) {
